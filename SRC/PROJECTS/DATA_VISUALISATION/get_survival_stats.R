...
cal.surv <- pan.data[, c("client_id", "account_opening_date", "account_closing_date")]
cal.surv <- data.table(cal.surv)
cal.surv$account_opening_date <- as.Date(cal.surv$account_opening_date)
cal.surv$account_closing_date <- as.Date(cal.surv$account_closing_date)
cal.surv$mean_1 <- cal.surv$account_opening_date + 365
length(which(cal.surv$account_closing_date <= cal.surv$mean_1))
cal.surv$mean_2 <- cal.surv$account_opening_date + 365*2
length(which(cal.surv$account_closing_date <= cal.surv$mean_2))
cal.surv$mean_5 <- cal.surv$account_opening_date + 365*5
length(which(cal.surv$account_closing_date <= cal.surv$mean_5))
cal.surv$mean_10 <- cal.surv$account_opening_date + 365*10
length(which(cal.surv$account_closing_date <= cal.surv$mean_10))
